    ...
    <div className="min-h-screen bg-[#F7F3EA] text-[#1D2823] selection:bg-[#DDE9D9]">
      <header className="sticky top-0 z-40 border-b border-[#173D35]/15 bg-[#F7F3EA]/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-10">
          <Link href="/" className="group flex min-w-0 items-center gap-3"><img className="h-10 w-10 shrink-0 object-contain transition-transform duration-200 group-hover:-rotate-6" src="/manus-storage/esg-school-index-mark_f4865f8f.png" alt="學校 ESG 指數標誌" /><span className="hidden min-w-0 leading-tight sm:block"><strong className="block font-serif text-base tracking-[0.08em] text-[#173D35]">學校 ESG 指數</strong><span className="block text-[10px] font-semibold tracking-[0.14em] text-[#64736A]">校園自我檢視工具</span></span></Link>
